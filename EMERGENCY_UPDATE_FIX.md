...
```
dist/
├── LOTO Key Management Setup 1.7.4.exe
└── latest.yml
```
...
2. **Fill in:**
   - Tag version: `v1.7.4`
   - Release title: `Version 1.7.4`
   - Description: Copy from CHANGELOG.md (version 1.7.4 section)

3. **Upload Files:**
   - Drag `LOTO Key Management Setup 1.7.4.exe` into assets
...
4. Click "Update Now" → Downloads 1.7.4 → Installs

## Done! 
Auto-updates will work for all future users installing 1.7.4.

---

## Alternative: Disable Auto-Updates for v1.7.4

If absolutely no time, you can:
1. Comment out auto-update check in main.js
